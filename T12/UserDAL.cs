...
namespace T12
{
	public class UserDAL
	{
		...
		public User? SelectByUsernameAndPassword(string username, string password)
		{
            ...
            cmd.Parameters.AddWithValue("1", Utils.Hash(password));
		...
		public int Insert(User u)
		{
            ...
            cmd.Parameters.AddWithValue("2", Utils.Hash(u.Password));
        ...
        public int UpdateFullname(User u)
        {
            ...
            command.Parameters.AddWithValue("@1", u.Fullname);
            return command.ExecuteNonQuery();
        }
        public int UpdateRole(User u)
        {
            string sql = "UPDATE USERS SET role = @1 WHERE id=@0";
            SqlCommand command = new SqlCommand(sql, conn);
            command.Parameters.AddWithValue("@0", u.Id);
            command.Parameters.AddWithValue("@1", u.Role);
            return command.ExecuteNonQuery();
        }
        public int UpdatePassword(User u)
        {
            ...
            SqlCommand command = new SqlCommand(sql, conn);
            command.Parameters.AddWithValue("@0", u.Id);
            command.Parameters.AddWithValue("@1", Utils.Hash(u.Password));
            return command.ExecuteNonQuery();
        }
